...
export default class TopSellersOrdersCities extends React.Component {
  constructor(props) {
    super(props)
    ...
    return (
        <div>
          <div>
            <MarkdownText
              text={`
              What about the TOP sellers (calculated by number of orders and customers which came back to them) and their cities?
              Are sellers from certain cities more popular than others?
              What about the 'worst' sellers? Which cities the sellers with less orders come from?`}
            />
